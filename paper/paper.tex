...
setup cost---the budgeted variant reaches
% TODO(bd_ms10k_b60): fill in when the exp_bd_prune2 sweep completes.
coverage comparable to blind bidirectional search while proving
unsolvability and pruning dead ends where the abstraction detects them.
