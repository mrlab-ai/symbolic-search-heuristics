...
blind forward search and our three width-bounded forward-search families;
the lower block lists external baselines.}
\label{tab-coverage}
\end{table}
...
A+I operator-potential planner ($652$). The remaining configurations that
...
the future work noted in Section~\ref{sec-effort}. The result we do claim
