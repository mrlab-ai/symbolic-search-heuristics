...
off.\footnote{Our implementation merges along a fixed linear variable
...
consume. Aligning the merge order with the search order is a natural
refinement.} In contrast, no small-width representation is known for
