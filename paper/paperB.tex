% RETIRED AS A SUBMISSION TARGET: this diagnosis-only split is superseded by
% the flagship paper.tex (which folds in its essence). Kept as the seed for
% the planned algorithms sequel ("Guidance without Fragmentation"), where the
% cost model returns as the foundation of new algorithms.
% =========================================================================
