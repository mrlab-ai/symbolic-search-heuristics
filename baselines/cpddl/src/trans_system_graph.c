                              ...
                              const pddl_trans_system_t *t)
{
    ...
    g->fw = ZALLOC_ARR(pddl_trans_system_graph_edges_t, g->num_states);
    g->bw = ZALLOC_ARR(pddl_trans_system_graph_edges_t, g->num_states);
...
static void computeDist(int num_states,
                        ...
                        int *dist)
{
    pddl_pq_el_t *els = ZALLOC_ARR(pddl_pq_el_t, num_states);
