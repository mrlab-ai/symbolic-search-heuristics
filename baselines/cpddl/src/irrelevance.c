                                ...
                                int *op_irr)
{
    ...
    queue = ZALLOC_ARR(int, s->fact.fact_size);
                            ...
                            pddl_err_t *err)
{
    ...
    fact_irr = ZALLOC_ARR(int, strips->fact.fact_size);
    op_irr = ZALLOC_ARR(int, strips->op.op_size);
                                   ...
                                   int *op_irr)
{
    ...
    queue = ZALLOC_ARR(int, fdr->var.var_size);
                               ...
                               pddl_err_t *err)
{
    ...
    var_to_op = ZALLOC_ARR(pddl_iset_t, fdr->var.var_size);
    ...
    var_irr = ZALLOC_ARR(int, fdr->var.var_size);
    op_irr = ZALLOC_ARR(int, fdr->op.op_size);
